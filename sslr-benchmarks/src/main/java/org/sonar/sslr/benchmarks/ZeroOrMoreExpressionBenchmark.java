...
public class ZeroOrMoreExpressionBenchmark {
  ...
  public void setup() {
    ...
    zeroOrMore = compile(new ZeroOrMoreExpression(new StringExpression("t")));
    optionalOneOrMore = compile(new OptionalExpression(new OneOrMoreExpression(new StringExpression("t"))));
  }
