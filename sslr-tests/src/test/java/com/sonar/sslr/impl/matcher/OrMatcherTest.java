...
public class OrMatcherTest {
  ...
  public void should_move_forward() {
    Matcher matcher = new OrMatcher(MockedMatchers.mockFalse(), MockedMatchers.mockTrue());
  ...
  public void should_not_move_forward() {
    Matcher matcher = new OrMatcher(MockedMatchers.mockFalse(), MockedMatchers.mockFalse());
    ParsingState parsingState = mock(ParsingState.class);
  ...
  public void test_toString() {
    assertThat(new OrMatcher().toString()).isEqualTo("or");
  }

  @Test
  public void test_equals_and_hashCode() {
    Matcher first = new OrMatcher(MockedMatchers.mockTrue());
    assertThat(first.equals(first)).isTrue();
    assertThat(first.equals(null)).isFalse();
    // different matcher
    assertThat(first.equals(MockedMatchers.mockTrue())).isFalse();
    // same submatchers
    Matcher second = new OrMatcher(MockedMatchers.mockTrue());
    assertThat(first.equals(second)).isTrue();
    assertThat(first.hashCode() == second.hashCode()).isTrue();
    // different submatchers
    Matcher third = new OrMatcher(MockedMatchers.mockFalse());
