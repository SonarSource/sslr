...
public class ParsingEventListenerTest {
	...
	public void ok() {
		...
		expected.append("Entered matcher and(MatcherAdapter(\"bonjour\"), MatcherAdapter(longestOne(RuleImplAdapter(rule1), RuleImplAdapter(rule2))), MatcherAdapter(and(MatcherAdapter(\"olaa\"), MatcherAdapter(\"uhu\"))), MatcherAdapter(EOF)) at index 0" + System.getProperty("line.separator"));
		...
		expected.append("Entered matcher longestOne(RuleImplAdapter(rule1), RuleImplAdapter(rule2)) at index 1" + System.getProperty("line.separator"));
		...
		expected.append("Entered matcher and(MatcherAdapter(\"hehe\"), MatcherAdapter(\"huhu\")) at index 1" + System.getProperty("line.separator"));
		expected.append("Entered matcher \"hehe\" at index 1" + System.getProperty("line.separator"));
		expected.append("Exit matcher \"hehe\" with match until index 2" + System.getProperty("line.separator"));
		...
		expected.append("Exit matcher and(MatcherAdapter(\"hehe\"), MatcherAdapter(\"huhu\")) with match until index 3" + System.getProperty("line.separator"));
		...
		expected.append("Exit matcher and(MatcherAdapter(\"hehe\"), MatcherAdapter(\"huhu\")) with match until index 3" + System.getProperty("line.separator"));
		expected.append("Exit rule rule2 with match until index 3" + System.getProperty("line.separator"));
		expected.append("Exit matcher longestOne(RuleImplAdapter(rule1), RuleImplAdapter(rule2)) with match until index 3" + System.getProperty("line.separator"));
		expected.append("Entered matcher and(MatcherAdapter(\"olaa\"), MatcherAdapter(\"uhu\")) at index 3" + System.getProperty("line.separator"));
		...
		expected.append("Exit matcher and(MatcherAdapter(\"olaa\"), MatcherAdapter(\"uhu\")) with match until index 5" + System.getProperty("line.separator"));
		...
		expected.append("Exit matcher and(MatcherAdapter(\"bonjour\"), MatcherAdapter(longestOne(RuleImplAdapter(rule1), RuleImplAdapter(rule2))), MatcherAdapter(and(MatcherAdapter(\"olaa\"), MatcherAdapter(\"uhu\"))), MatcherAdapter(EOF)) with match until index 6" + System.getProperty("line.separator"));
