...
public class SequenceMatcherBuilder implements MatcherBuilder {

  private final MatcherBuilder[] subMatcherBuilders;

  public SequenceMatcherBuilder(MatcherBuilder... subMatcherBuilders) {
    this.subMatcherBuilders = subMatcherBuilders;
  }

  public Matcher build(Grammar g) {
    return new SequenceMatcher(MatcherBuilderUtils.convertToMatchers(g, subMatcherBuilders));
  }
